...
export const ColomnsServicePatch = [
    ...
    },
    {
        ...
        Cell: ({value}) => { return (<RedactSelect path_for_serv="http://127.0.0.1:8000/api/service/v1/typeofservice/"
             message="обязательно заполнить" field_name="type_of_service" value={value}/>)},
        disableSortBy: true,
    },
    {
