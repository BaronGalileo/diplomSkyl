...
export const ColumnsMachinePatch = [
    ...
    // },
    {
        ...
        accessor: 'car_model',
        Cell: ({value}) => { return (<RedactSelect path_for_serv="http://127.0.0.1:8000/api/v1/carmodel/" message="обязательно заполнить" field_name="car_model" value={value}/>)}
    },
    {
        Header: 'Модель двигателя',
        accessor: 'engine_model',
        Cell: ({value}) => { return (<RedactSelect path_for_serv="http://127.0.0.1:8000/api/v1/enginemodel/" message="обязательно заполнить" field_name="engine_model" value={value}/>)}
    },
    {
    ...
    },
    {
        ...
        Cell: ({value}) => { return (<RedactSelect path_for_serv="http://127.0.0.1:8000/api/v1/transmissionmodel/" message="обязательно заполнить" field_name="transmission_model" value={value} />)}
    },
    {
    ...
    },
    {
        ...
        Cell: ({value}) => { return (<RedactSelect path_for_serv="http://127.0.0.1:8000/api/v1/drivingaxlemodel/" message="обязательно заполнить" field_name="driving_axle_model" value={value}/>)}
    },
    {
    ...
    },
    {
        ...
        Cell: ({value}) => { return (<RedactSelect path_for_serv="http://127.0.0.1:8000/api/v1/modelofacontrolledbridge/" message="обязательно заполнить" field_name="model_of_a_controlled_bridge" value={value}/>)}
    },
    {
